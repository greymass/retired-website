module.exports = {
  siteMetadata: {
    ...
    anchor: {
      ...
      macDownloadUrl:
        "https://github.com/greymass/anchor/releases/download/v1.3.5/mac-anchor-wallet-1.3.5-x64.dmg",
      windowsDownloadUrl:
        "https://github.com/greymass/anchor/releases/download/v1.3.5/win-anchor-wallet-1.3.5.exe",
    },
  },
  plugins: [
    {
