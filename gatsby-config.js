module.exports = {
  siteMetadata: {
    ...
    anchor: {
      ...
      macDownloadUrl: 'https://github.com/greymass/anchor/releases/download/v1.3.1/mac-anchor-wallet-1.3.1-x64.dmg',
      windowsDownloadUrl: 'https://github.com/greymass/anchor/releases/download/v1.3.1/win-anchor-wallet-1.3.1.exe',
    }
  },
  plugins: [
    {
